...
const Task: React.FC<TaskProps> = ({ curTask }) => {
  ...
  return (
    <div
      className={`w-full rounded-lg border border-gray-200 bg-white shadow-sm p-4 m-3 border-l-4 ${leftBorderColor}`}
    >
      <div className="flex items-start gap-3">
        <div className="pt-1">
          <button
            type="button"
            role="checkbox"
            className="peer w-4 h-4 shrink-0 rounded-sm border border-gray-950 focus-visible:outline-none"
          ></button>
        </div>
        <div id="priority" className="flex-1">
          <div className="flex items-center justify-between">
            <span className="text-sm font-medium ">{curTask.text}</span>
            <span
          ...
          <div id="dueDate" className="flex items-center flex-wrap gap-2 mt-2">
        ...
        <div className="flex gap-1">
          <button
            type="button"
            role="edit"
            className="h-8 w-8 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors hover:bg-indigo-50 hover:text-gray-900"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
          ...
          <button
            type="button"
            role="delete"
            className="h-8 w-8 inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors hover:bg-red-100 hover:text-red-600"
